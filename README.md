...
setup (app) {
    ...
    // Exécutez votre code SQL ici en utilisant la méthode query
    ...
    // Appelez la fonction pour exécuter le code SQL
    executeSQL()

    // Vous pouvez également stocker le client Supabase dans l'application pour y accéder ailleurs
